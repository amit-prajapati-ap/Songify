...
const Favorite = () => {
  ...
  return (
    <>
      <div className="grid grid-cols-5 md:grid-cols-8 mt-10 mb-4 pl-2 text-gray-shade-1">
        <p className="md:col-span-5 min-[500px]:col-span-2 col-span-3">
      ...
      {filteredfavorites.map((song, index) => (
        <div
          ...
          key={index}
          className="grid grid-cols-5 md:grid-cols-8 gap-2 p-2 items-center hover:bg-dark-shade-2 cursor-pointer text-gray-shade-1 border-b border-zinc-700"
        >
